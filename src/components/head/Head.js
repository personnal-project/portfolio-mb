...
function Head() {
  ...
  return (
    <div className="Head">
      <section className='head-index'>
        ...
        <div className='bar'>
          ...
          <div className='navbar'>
              ...
              <Link to="competences" smooth={true} duration={1000}><li>Compétences</li></Link>
      ...
      <section className='Head-mob'></section> 
    </div>
  );
}
